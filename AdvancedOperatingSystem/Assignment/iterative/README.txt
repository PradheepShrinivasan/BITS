...
Output of the code
==================
The clinet code on starting up the program would display an interactive menu. 
...
Additional comments
--------------------
	An intertive server services once request at a time.Hence it can contain static variables. 
